			...
			if (message.indexOf(COMMAND_TRIGGER) > -1) {
				...
				switch (command) {
					...
					case ROLL:   // UCID; hhm7
						...
						response = "<i><b>You</b> rolled</i> <u>" + Integer.toString(ran) + "</u>";
						// wasCommand = true;
						break;
					case FLIP:
						String[] coin = { "Heads", "Tails" };
						int rnd = new Random().nextInt(2);
						response = "<i><b style=\"color: gray;\">Coin</b> flipped</i> <u>" + coin[rnd] + "</u>";
						// wasCommand = true;
						break;
					case COLOR:
						response = "<span style=\"color: red" + comm2[1] + ";\">" + textEffects(String.join(" ", Arrays.copyOfRange(comm2, 2, comm2.length))) + "</span>";
						// wasCommand = true;
						break;
					case MUTE:
						...
						if (!client.isMuted(username_mute)) {
							client.mutedUsers.add(username_mute);
					...
					case UNMUTE:
						...
						if (client.isMuted(username_unmute)) {
							client.mutedUsers.remove(username_unmute);
							client.saveMutedUsers();
