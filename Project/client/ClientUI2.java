...
public class ClientUI2 extends JFrame implements Event {
	/**
	 * 
	 */
	...
	private final static Logger log = Logger.getLogger(ClientUI2.class.getName());
	Dimension windowSize = Toolkit.getDefaultToolkit().getScreenSize();
	String username;
	RoomsPanel roomsPanel;
	JMenuBar menu;

	public ClientUI2(String title) {
	...
	public static void main(String[] args) {
		ClientUI2 ui = new ClientUI2("ChatRoom");
		if (ui != null) {
