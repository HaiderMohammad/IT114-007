...
public class ClientUI1 extends JFrame implements Event {
	/**
	 * 
	 */
	...
	private final static Logger log = Logger.getLogger(ClientUI1.class.getName());
	Dimension windowSize = Toolkit.getDefaultToolkit().getScreenSize();
	String username;
	RoomsPanel roomsPanel;
	JMenuBar menu;

	public ClientUI1(String title) {
	...
	public static void main(String[] args) {
		ClientUI1 ui = new ClientUI1("ChatRoom");
		if (ui != null) {
